...
public abstract class Aircraft {
    ...
    public Vector3 velocity { get; protected set; } = new (0, 0, 50);
    /// <summary> Angle in radians the aircraft is offset from its resting position in the latteral axis. </summary>
    public float pitch { get; protected set; } = 20 * (2*(float)Math.PI / 360f);
    ...
    /// <summary> Angle in radians the aircraft is offset from its resting position in the logitudinal axis. </summary>
    public float roll { get; protected set; } = 0;
    /// <summary>
    ...
    protected float ComputeAOA() {
        ...
        Matrix4x4 local2world = Matrix4x4.CreateFromYawPitchRoll(yaw, pitch, roll);
